...
module.exports = {
  async up(queryInterface) {
    ...
    const id = (nombre) => {
      ...
      if (!cat)
        throw new Error(
          `[01-categoria] Categoría padre no encontrada: "${nombre}"`
        );
      return cat.id;
    };
    ...
    await queryInterface.bulkInsert(
      ...
      [
        {
          nombre: 'Fuente de Poder Certificada',
          padreId: id('Fuente de Poder'),
        },
    ...
    await queryInterface.bulkInsert(
      ...
      [
        {
          nombre: 'Placa de Bluetooth PCIe',
          padreId: id('Placa de Bluetooth'),
        },
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          nombre: 'Procesador Intel LGA 1851',
          padreId: id('Procesador Intel'),
        },
        {
          nombre: 'Procesador Intel LGA 1700',
          padreId: id('Procesador Intel'),
        },
        {
          nombre: 'Procesador Intel LGA 1200',
          padreId: id('Procesador Intel'),
        },
        {
          nombre: 'Procesador Intel LGA 1151',
          padreId: id('Procesador Intel'),
        },
      ],
      {}
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          nombre: 'Motherboard Intel LGA 1851',
          padreId: id('Motherboard Intel'),
        },
        {
          nombre: 'Motherboard Intel LGA 1700',
          padreId: id('Motherboard Intel'),
        },
        {
          nombre: 'Motherboard Intel LGA 1200',
          padreId: id('Motherboard Intel'),
        },
        {
          nombre: 'Motherboard Intel LGA 1151',
          padreId: id('Motherboard Intel'),
        },
      ],
      {}
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          nombre: 'Teclado de Oficina Wireless',
          padreId: id('Teclado de Oficina'),
        },
        {
          nombre: 'Teclado de Oficina Con Cable',
          padreId: id('Teclado de Oficina'),
        },
      ],
      {}
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          nombre: 'Mouse de Oficina Wireless',
          padreId: id('Mouse de Oficina'),
        },
        {
          nombre: 'Mouse de Oficina Con Cable',
          padreId: id('Mouse de Oficina'),
        },
      ],
      {}
    ...
    await queryInterface.bulkInsert(
      ...
      [
        {
          nombre: 'Auriculares Gamer Wireless',
          padreId: id('Auriculares Gamer'),
        },
        {
          nombre: 'Auriculares Gamer Con Cable',
          padreId: id('Auriculares Gamer'),
        },
        {
          nombre: 'Auriculares de Oficina Wireless',
          padreId: id('Auriculares de Oficina'),
        },
        {
          nombre: 'Auriculares de Oficina Con Cable',
          padreId: id('Auriculares de Oficina'),
        },
      ],
      {}
    ...
    await queryInterface.bulkInsert(
      ...
      [
        {
          nombre: 'Almacenamiento SSD M.2 NVME',
          padreId: id('Almacenamiento SSD M.2'),
        },
        {
          nombre: 'Almacenamiento SSD M.2 SATA',
          padreId: id('Almacenamiento SSD M.2'),
        },
      ],
      {}
