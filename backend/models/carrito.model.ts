...
export class CarritoModel
  ...
  static async createCart(cartInput: CartCreationAttributes): Promise<CarritoModel> {
    return await CarritoModel.create(cartInput);
  }

  static async updateCart(id: number, updateData: Partial<CarritoModelAttributes>): Promise<CarritoModel | null> {
